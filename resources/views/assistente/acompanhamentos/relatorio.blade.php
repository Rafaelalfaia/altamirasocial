...
@section('content')
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-xl shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm mb-6">
            ...
            <p><strong>Grávida:</strong> {{ $acompanhamento->possui_gravida ? 'Sim' : 'Não' }}
                {{ $acompanhamento->nome_gravida }}
            </p>
            <p><strong>Idoso:</strong> {{ $acompanhamento->possui_idoso ? 'Sim' : 'Não' }} {{ $acompanhamento->nome_idoso }}
            </p>
