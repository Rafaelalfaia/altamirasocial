...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    ...
    <h1 class="text-2xl font-bold mb-6 text-green-800">➕ Novo Atendente</h1>
    ...
    <form method="POST" action="{{ route('restaurante.coordenador.atendentes.store') }}">
        @csrf

        {{-- Nome --}}
        <div class="mb-4">
            <label class="block text-sm font-medium">Nome Completo</label>
            <input type="text" name="name" value="{{ old('name') }}" required class="w-full border-gray-300 rounded px-3 py-2 shadow-sm">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" value="{{ old('email') }}" class="w-full border-gray-300 rounded px-3 py-2 shadow-sm">
        </div>

        {{-- Senha --}}
        <div class="mb-4">
            <label class="block text-sm font-medium">Senha</label>
            <input type="password" name="password" required class="w-full border-gray-300 rounded px-3 py-2 shadow-sm">
        </div>

        {{-- Confirmação de Senha --}}
        <div class="mb-4">
            <label class="block text-sm font-medium">Confirmar Senha</label>
            <input type="password" name="password_confirmation" required class="w-full border-gray-300 rounded px-3 py-2 shadow-sm">
        </div>
