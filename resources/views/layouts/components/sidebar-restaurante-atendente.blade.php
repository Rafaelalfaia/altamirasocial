...
<div class="h-full w-64 {{ $bgSidebar }} text-white shadow-lg border-r">
    ...
    <div class="p-6 bg-green-950 border-b border-green-800 flex flex-col justify-center items-center h-24">
        ...
        <span class="text-xs uppercase tracking-wider text-gray-300">Atendente Restaurante</span>
    </div>
    ...
    <nav class="p-4 space-y-2">
        <ul class="space-y-1 text-sm font-medium">
            ...
            {{-- Dashboard --}}
            <li>
                <a href="{{ route('restaurante.atendente.dashboard') }}"
                   class="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-green-800 {{ request()->routeIs('restaurante.atendente.dashboard') ? 'bg-green-700 font-semibold' : '' }}">
                    🏠 Dashboard
                </a>
            </li>

            {{-- Cidadãos --}}
            <li class="mt-4 text-xs text-gray-300 uppercase tracking-wider px-4">Cidadãos</li>
            <li>
                 <a href="{{ route('restaurante.atendente.cidadaos.create') }}"
            ...
            {{-- Vendas --}}
            <li>
                <a href="{{ route('restaurante.atendente.vendas.index') }}"
            ...
            <li>
                <a href="{{ route('restaurante.atendente.relatorios.index') }}"
                   class="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-green-800">
                    📈 Minhas Vendas
                </a>
            </li>
